...
$\mathsf{a} \triangleq \langle \mathsf{Id}(c_i) \in \mathbb{N}^{32}_8, j \in \mathbb{N}_{16} \rangle$.
...
Сontract memory is a tuple $\langle \mathcal{D}, \mathcal{I} \rangle$,
